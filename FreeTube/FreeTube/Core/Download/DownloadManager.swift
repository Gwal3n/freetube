...
final class DownloadManager: TemporaryDownloading {
    ...
    private func runYoutubeDLDownload(video: Video, quality: VideoQuality, priority: DownloadPriority = .background) async throws -> URL {
        ...
        // was the JS-runtime-less n-cipher (CLAUDE.md §15.4). The earlier cookie-file experiment
        // was removed so session credentials can never be materialized as plaintext temporary data.
        let argv: [String] = [
